...
function at_commerce_process_page(&$vars) {
  ...
  // Provide backwards compatibility in case the user does not immediatly update to the latest version of AT Core.
  // TODO: eventually remove when usage of AT 7.x-3.2 falls sufficiently low.
